...
<html>
<head>
	<title>Three Kingdoms :: Wei</title>
		...
		<div class="w3-row-padding">
			<c:forEach var="weiList" items="${weiVo}">
				<div class="w3-third w3-container w3-margin-bottom">
					<a href="#"><img src="${pageContext.request.contextPath}/uploadFile?fileWeiName=${weiList.fileWei.fileWeiName}&fileWeiExt=${weiList.fileWei.fileWeiExt}" alt="위나라" style="width:100%;" class="w3-hover-opacity"></a>
