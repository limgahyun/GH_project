	...
	<div  class="w3-content"style="max-width:1600px">
		...
		<div class="w3-row-padding" style="padding-bottom: 120px;">
			<div class="w3-third w3-container w3-margin-bottom">
				<a href="${pageContext.request.contextPath}/kingdomWei"><img src="${pageContext.request.contextPath}/resources/threekingdoms/image/wei.jpg" alt="위나라" style="width:100%;" class="w3-hover-opacity"></a>
			...
			<div class="w3-third w3-container w3-margin-bottom">
				<a href="${pageContext.request.contextPath}/kingdomChu"><img src="${pageContext.request.contextPath}/resources/threekingdoms/image/chu.jpg" alt="촉나라" style="width:100%;" class="w3-hover-opacity"></a>
				<div class="w3-container w3-white" style="height:200px">
			...
			<div class="w3-third w3-container" >
				<a href="${pageContext.request.contextPath}/kingdomWu"><img src="${pageContext.request.contextPath}/resources/threekingdoms/image/wu.jpg" alt="오나라" style="width:100%" class="w3-hover-opacity"></a>
				<div class="w3-container w3-white"style="height:200px">
